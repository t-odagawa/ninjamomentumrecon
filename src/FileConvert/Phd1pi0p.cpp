...
int main(int argc, char* argv[]) {
  ...
  TH1D *hist_q2 = new TH1D("hist_q2","", 10, 0, 1e6);
  TH1D *hist_q2_range = new TH1D("hist_q2_range", "", 10, 0, 1e6);
  TH1D *hist_nu_ene_recon = new TH1D("hist_nu_ene_recon", "", 20, 0, 2000.);
  TH1D *hist_nu_ene_recon_range = new TH1D("hist_nu_ene_recon_range", "", 200, 0, 2000);
  
  TH1D *hist_dpt = new TH1D("hist_dpt", "", 200, 0., 2000.);
  TH1D *hist_dpt_range = new TH1D("hist_dpt_range", "", 200, 0., 2000.);
  TH1D *hist_dalphat = new TH1D("hist_dalphat", "", 90, 0., 180.);
  TH1D *hist_dalphat_range = new TH1D("hist_dalphat_range", "", 90, 0., 180.);
  TH1D *hist_cosdat = new TH1D("hist_cosdat", "", 100, -1., 1.);
  TH1D *hist_cosdat_range = new TH1D("hist_cosdat_range", "", 100, -1., 1.);
  TH1D *hist_dphit = new TH1D("hist_dphit", "", 90, 0, 180);
  TH1D *hist_dphit_range = new TH1D("hist_dphit_range", "", 90, 0, 180.);
  TH1D *hist_cosdphit = new TH1D("hist_cosdphit", "", 100, -1, 1);
  TH1D *hist_cosdphit_range = new TH1D("hist_cosdphit_range", "", 100, -1, 1);
  TH1D *hist_dptx = new TH1D("hist_dptx", "", 200, 0., 2000.);
  TH1D *hist_dptx_range = new TH1D("hist_dptx_range", "", 200, 0., 2000.);
  TH1D *hist_dpty = new TH1D("hist_dpty", "", 200, 0., 2000.);
  TH1D *hist_dpty_range = new TH1D("hist_dpty_range", "", 200, 0., 2000.);
  ...
  for ( auto ev : ev_vec ) {
    ...
    if ( num_muon == 1 && num_proton == 0 && num_pion == 1 && num_other == 0 ) {
      sample_flag = true;
    }
