void DrawAngleResAng() {


  TString filename_wo = "/home/t2k/odagawa/muon_wo_angres_ang_graph.root";
  TString filename_w = "/home/t2k/odagawa/muon_w_angres_ang_graph.root";
  ...
  ge_bias_w->GetYaxis()->SetRangeUser(-0.002, 0.01);
  ge_bias_w->Draw("AP");
  ge_bias_w->SetMarkerStyle(20);
  ge_bias_w->SetMarkerColor(kRed);
  
  ge_bias_w->SetTitle(";tan#theta;Fractional Bias");
  ...
  ge_width_w->GetYaxis()->SetRangeUser(0.05, 0.1);
  ge_width_w->Draw("AP");
  ge_width_w->SetMarkerStyle(20);
  ge_width_w->SetMarkerColor(kRed);
  
  ge_width_w->SetTitle(";tan#theta;Fractional Width");
